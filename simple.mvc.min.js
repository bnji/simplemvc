var CMN={LOG:function(c){console.log(c)},JSTR:function(c){return CMN.JSTR(c,null,2)}},MVC={Controller:function(c){return c},ModelView:function(c,a,b){if(null===a||void 0===a)a={};if(null===b||void 0===b)b={};var e=b.clone;if(void 0!==e){e.template=c;var c=e.id,g=c.substring(1,c.length),f=$($(e.template).clone(e.withDataAndEvents)).attr("id",g);$(f).find("[datasrc]").attr("datasrc",c);$(f).find("button,:submit").each(function(d,b){$(this).attr("id",b.id+"_"+g).bind("click",function(d){a.ExecuteController(d.target.name)});
console.log(d+" "+b.id)});f.show();e.append(f)}void 0===b.viewId&&$.extend(b,{viewId:c});void 0===b.reflectModelChangeInView&&$.extend(b,{reflectModelChangeInView:!0});void 0===b.eventUsed&&$.extend(b,{eventUsed:""});a.Save=function(d){a.ExecuteController("Save",d)};a.Update=function(d){a.ExecuteController("Update",d)};a.Delete=function(d){a.ExecuteController("Delete",d)};a.Clear=function(d){a.Set(d,"")};a.ClearAll=function(){};a.AddGetSet=function(d,b){$(a).bind("get"+d,function(b,c){c.value=a[d]}).bind("set"+
...
b&&(b=a[b],c(this).text(b))});$this.getInputElements(this).each(function(){var b=a[c(this).attr("name")],e;void 0!==b&&(e=c(this),e.is(":radio")?e.val()===b&&e.attr("checked",!0):(e.is(":checkbox")&&(b=c.isArray(b)?b:[b],-1<c.inArray(e.val(),b)&&e.attr("checked",!0)),e.val(b)))})},getValues:function(){var a={},b={};$this=this;$this.getInputElements(this).each(function(){var a=c(this),g=a.attr("type"),f=a.attr("name"),d=a.val();"submit"!==g&&f&&(a.hasClass("isNumber")&&(d=parseInt(d)),a.is(":checkbox")?
(d=!1,a.attr("checked")&&(d=!0),b[f]=d):a.is(":radio")?a.attr("checked")&&(b[f]=d):b[f]=d)});$this.getDivElements(this).each(function(){var b=c(this),g=b.text();if(void 0!==g){var f=$this.getElementKey(this);void 0!==f&&(b.hasClass("isNumber")&&(g=parseInt(g)),a[f]=g)}});c.extend(a,b);return a}})})(jQuery);