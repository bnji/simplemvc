...
void 0===d.viewId&&(d.viewId=c);void 0===d.reflectModelChangeInView&&(d.reflectModelChangeInView=!0);void 0===d.eventUsed&&(d.eventUsed="");void 0===d.preventDefault&&(d.preventDefault=!0);void 0===d.datasrc&&(d.datasrc=c);var f=d.datasrc,e=d.clone;if(void 0!==e){e.template=c;var c=e.id,i=c.substring(1,c.length),h=e.withDataAndEvents,i=$($(e.template).clone(void 0!==h?h:!1)).attr("id",i);$(i).find('[datasrc=""]').attr("datasrc",f);e.append(i)}$(c+" button,"+c+" a,"+c+" submit,"+c+" i").each(function(){$(this).click(function(b){a.RunCtr(b.target.name,
b);d.settings.preventDefault&&b.preventDefault()})});a.Save=function(b){a.RunCtr("Save",b);return a};a.Update=function(b){a.RunCtr("Update",b);return a};a.Delete=function(b){a.RunCtr("Delete",b);return a};a.Clear=function(b){a.Set(b,"");return a};a.ClearAll=function(){$.each(a.GetModelData(),function(b){a.Clear(b)});return a};a.AddGetSet=function(b){$(a).bind("get"+b,function(c,d){d.value=a[b]}).bind("set"+b,function(c,d){a[b]!==d&&(a[b]=d,a.SetViewFromModel(),a.TriggerEvent(b,"change"))});return a};
a.RemoveGetSet=function(b){$(a).unbind("get"+b).unbind("set"+b);return a};a.TriggerEvent=function(b,d){$(c+' :input[name="'+b+'"]').not(".excludeFromModel").trigger(d);return a};a.AddProperty=function(b){a.AddEvents().AddGetSet(b).TriggerEvent(b,"keyup");console.log("Added property "+b+" to the Model.");return a};a.RemoveProperty=function(b){a.RemoveGetSet(b);delete a[b];$(c+' :input[name="'+b+'"]').not(".excludeFromModel").remove();console.log("Removed property "+b+" from the Model.");return a};
a.Set=function(b,c){$(a).triggerHandler("set"+b,[c]);a.SetDataboundDomVal(f,b,c);return a};a.Get=function(b){var c={value:void 0};$(a).triggerHandler("get"+b,[c]);return c.value};a.Has=function(b){return void 0!==a.Get(b)?!0:!1};a.GetModelData=function(b){var c={};$.each(a,function(a,d){if("function"!==(typeof d).toString()){if(/jQuery\d*/.test(a)||!b&&"settings"===a)return!0;c[a]=d}});return c};a.GetDatasrcId=function(){return a.datasrc};a.GetViewData=function(){return $(c).getSetHtml()};a.SetViewFromModel=
function(){$(c).getSetHtml(a);return a};a.SetModelFromView=function(){var b=a.GetViewData();$.each(b,function(b,d){a[b]!==d&&(a[b]=d);a.SetDataboundDomVal(c,b,d)});return a};a.SetDataboundDomVal=function(b,c,d){$("div[datasrc|="+b+"][name|="+c+"],p[datasrc|="+b+"][name|="+c+"],span[datasrc|="+b+"][name|="+c+"]").text(d);$("input[datasrc|="+b+"][name|="+c+"]").val(d);return a};a.RunEvent=function(b){var c=b.type;void 0===c&&(c=b);if(void 0!==b)return 0<$.trim(b.target.name).length?void 0!==d.settings[c]&&
...
a.RunEvent(b)}).select(function(b){a.RunEvent(b)}).submit(function(b){a.RunEvent(b)}).keyup(function(b){void 0===d.settings.keyup&&a.SetModelFromView();a.RunEvent(b)}).keypress(function(b){a.RunEvent(b)}).keydown(function(b){a.RunEvent(b)});return a};a.SetViewFromModel();a.SetModelFromView();d.reflectModelChangeInView&&$.each(a,function(b){a.AddGetSet(b)});0<d.autoSaveInterval&&(d.eventUsed='"autoSave"',setInterval(function(){a.Save()},d.autoSaveInterval));a.AddEvents();d={settings:d};$.extend(a,
d);var g=a.init;void 0!==g&&null!==g&&setTimeout(function(){g()},1);return a}};
